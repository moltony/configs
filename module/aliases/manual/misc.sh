...
alias relcp='reloadcpath' # Short reloadcpath...wait why is it spelled without a hyphen
...
alias pmbnitud='python3 -m build --no-isolation && twine upload dist/*' # shorthand
